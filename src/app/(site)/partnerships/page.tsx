      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            İşbirliklerimiz ve <span className="text-primary">Fırsatlar</span>
          </h1>
          <p className="text-xl text-text-secondary max-w-2xl mx-auto">
            Kulüp üyelerimize özel ayrıcalıklar, indirimler ve fırsatlar dünyası.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex flex-col flex-grow">
                ...
                <p className="text-text-secondary text-sm mb-6 min-h-[48px]">
                  {partner.description || "Startup ve Finans Kulübü üyelerine özel indirim."}
                </p>
        ...
        {partners.length === 0 && (
          <div className="text-center py-20 bg-white/5 rounded-2xl border border-white/10">
            <p className="text-2xl text-slate-400">Henüz iş ortağı bulunmuyor.</p>
          </div>
        )}
      </div>
    </main>
